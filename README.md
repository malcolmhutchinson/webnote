...
A page's children will usually be sorted alphanumerically. The order
can be affected by commands in the metadata file.
...
type, with these types identified:
    ...
    html           A test-encoded containing HTML.
